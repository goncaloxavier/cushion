...
export const productCategory = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'videoUrl',
      title: 'Vídeo do produto (YouTube)',
      description: 'Opcional. Quando preenchido, aparece na página de detalhe deste produto.',
      type: 'url',
      group: 'conteudo',
    }),
    defineField({
      ...
      description: 'Legenda curta para o vídeo, também usada por leitores de ecrã.',
      type: 'localizedString',
      group: 'conteudo',
    }),
    defineField({
      name: 'toolUrl',
      title: 'Link da ferramenta externa',
      description: 'Opcional. Exemplo: simulador, calculadora ou configurador relacionado com o produto.',
      type: 'url',
      group: 'conteudo',
    }),
    defineField({
      ...
      description: 'Título curto mostrado no bloco da ferramenta externa.',
      type: 'localizedString',
      group: 'conteudo',
    }),
    defineField({
      name: 'toolText',
      title: 'Texto de apoio da ferramenta',
      description: 'Frase curta a explicar o que a pessoa pode fazer nesse link.',
      type: 'localizedText',
      group: 'conteudo',
    }),
    defineField({
