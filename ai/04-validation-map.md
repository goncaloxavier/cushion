...
- Required checks: `npm audit --audit-level=high --omit=dev`, `npm run check`, `npm run lint`, `npm run build`, `npm run build:studio`, `npm run db:migrate`, and `npm run e2e`.
