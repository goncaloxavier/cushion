...
- Sanity Studio UX/content editing review for product categories, case studies, blog posts, the `Conteúdo do site` singleton, and the private CRM requests/client-profile workflow.
