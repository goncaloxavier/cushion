...
2. Make Sanity understandable in Portuguese and useful for editing page copy, products, Loja items/prices, case studies, blog posts, catalogue/contact content, and imagery.
...
6. Confirm final client copy, imagery, Loja images, final pricing/catalogue rules, production domains, and Studio hosting/access process.
