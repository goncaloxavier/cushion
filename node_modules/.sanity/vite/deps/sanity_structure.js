import {
  ...
  usePaneRouter,
  useStructureTool
} from "./chunk-3FWKRQ5G.js";
import "./chunk-E7SONWQ6.js";
import {
  Button,
  CommandList,
  CreateButton,
...
function IncomingReferencesType(t0) {
  ...
  const schemaType = t4, client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), [isAdding, setIsAdding] = (0, import_react.useState)(false), [newReferenceId, setNewReferenceId] = (0, import_react.useState)(null), {
    editState
  ...
  let t10;
  $[28] !== actions || $[29] !== referenced.id ? (t10 = (document_1) => (0, import_jsx_runtime.jsx)(IncomingReferenceDocument$1, { document: document_1, referenceToId: referenced.id, actions }), $[28] = actions, $[29] = referenced.id, $[30] = t10) : t10 = $[30];
  ...
  if (loading) {
    ...
    let t122;
    return $[33] !== t112 ? (t122 = (0, import_jsx_runtime.jsx)(LoadingBlock, { showText: true, title: t112 }), $[33] = t112, $[34] = t122) : t122 = $[34], t122;
  }
  let t11;
  $[35] !== schemaType?.title || $[36] !== shouldRenderTitle || $[37] !== type.title ? (t11 = shouldRenderTitle && (0, import_jsx_runtime.jsx)(Box, { paddingY: 2, paddingX: 0, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: type.title || schemaType?.title }) }), $[35] = schemaType?.title, $[36] = shouldRenderTitle, $[37] = type.title, $[38] = t11) : t11 = $[38];
  let t12;
  $[39] !== documents || $[40] !== isAdding || $[41] !== newReferenceId || $[42] !== renderItem || $[43] !== schemaType?.title || $[44] !== t || $[45] !== type.title ? (t12 = documents.length > 0 ? (0, import_jsx_runtime.jsx)(IncomingReferencesListContainer, { $itemCount: documents.length, children: (0, import_jsx_runtime.jsx)(CommandList, { activeItemDataAttr: "data-hovered", ariaLabel: t("incoming-references-input.list-label", {
    type: type.title || schemaType?.title
  }), canReceiveFocus: true, fixedHeight: true, getItemKey: (index) => documents[index]._id, itemHeight: INCOMING_REFERENCES_ITEM_HEIGHT, items: documents, onlyShowSelectionWhenActive: true, overscan: 5, renderItem, wrapAround: false }) }) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "center", padding: 2, hidden: isAdding || !!newReferenceId, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t("incoming-references-input.no-items") }) }) }), $[39] = documents, $[40] = isAdding, $[41] = newReferenceId, $[42] = renderItem, $[43] = schemaType?.title, $[44] = t, $[45] = type.title, $[46] = t12) : t12 = $[46];
  let t13;
  $[47] !== newReferenceId || $[48] !== schemaType ? (t13 = newReferenceId && (0, import_jsx_runtime.jsx)(SanityDefaultPreview, { icon: schemaType.icon, layout: "default", isPlaceholder: true }), $[47] = newReferenceId, $[48] = schemaType, $[49] = t13) : t13 = $[49];
  let t14;
  $[50] !== creationAllowed || $[51] !== fieldName || $[52] !== handleLinkDocument || $[53] !== isAdding || $[54] !== referenced || $[55] !== type.type ? (t14 = isAdding && (0, import_jsx_runtime.jsx)(AddIncomingReference, { type: type.type, referenced, onCreateNewReference: handleCreateNewReference, onLinkDocument: handleLinkDocument, creationAllowed, fieldName }), $[50] = creationAllowed, $[51] = fieldName, $[52] = handleLinkDocument, $[53] = isAdding, $[54] = referenced, $[55] = type.type, $[56] = t14) : t14 = $[56];
  let t15;
  $[57] !== t12 || $[58] !== t13 || $[59] !== t14 ? (t15 = (0, import_jsx_runtime.jsxs)(Card, { radius: 2, padding: 1, border: true, tone: "default", children: [
    t12,
    t13,
    t14
  ] }), $[57] = t12, $[58] = t13, $[59] = t14, $[60] = t15) : t15 = $[60];
  let t16;
  $[61] !== creationAllowed || $[62] !== fieldName || $[63] !== onLinkDocument || $[64] !== referenced.id || $[65] !== referenced.type || $[66] !== t || $[67] !== type.type ? (t16 = onLinkDocument ? (0, import_jsx_runtime.jsx)(Button, { size: "large", disabled: false, icon: AddIcon, mode: "ghost", onClick: handleAdd, text: t("incoming-references-input.add-reference-item") }) : (0, import_jsx_runtime.jsx)(CreateNewIncomingReference, { type: type.type, referenceToId: referenced.id, referenceToType: referenced.type, creationAllowed, onCreateNewReference: handleCreateNewReference, fieldName }), $[61] = creationAllowed, $[62] = fieldName, $[63] = onLinkDocument, $[64] = referenced.id, $[65] = referenced.type, $[66] = t, $[67] = type.type, $[68] = t16) : t16 = $[68];
  let t17;
  return $[69] !== t11 || $[70] !== t15 || $[71] !== t16 ? (t17 = (0, import_jsx_runtime.jsxs)(Stack, { space: 2, marginBottom: 2, children: [
    t11,
    t15,
    t16
