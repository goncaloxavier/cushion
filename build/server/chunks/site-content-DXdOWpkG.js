...
const getLanguage = (value) => {
  if (value && supportedLanguages.has(value)) return value;
  ...
  pt: [
    {
      ...
      description: "Uma alternativa à madeira para decks, passadiços, rampas e zonas de permanência onde a resistência à humidade e a baixa manutenção contam.",
    ...
    },
    {
      ...
      description: "Soluções para vedações, divisórias de terreno, resguardos de ecopontos e proteção de zonas técnicas.",
    ...
    },
    {
      ...
      description: "Equipamentos robustos para locais onde a durabilidade, a limpeza simples e a presença discreta são decisivas.",
    ...
    },
    {
      ...
      description: "Produtos para criar zonas de apoio e permanência sem depender da manutenção típica da madeira tradicional.",
    ...
    },
    {
      ...
      description: "Peças pensadas para hortas, compostagem urbana, caixas de cultivo e separação limpa de zonas verdes.",
  ...
  en: [
    {
      ...
      description: "An alternative to timber for decks, walkways, ramps and outdoor areas where moisture resistance and low maintenance matter.",
    ...
    },
    {
      ...
      description: "Solutions for fences, land dividers, recycling-point screens and technical-area protection.",
    ...
    },
    {
      ...
      description: "Robust equipment for places where durability, simple cleaning and a quiet visual presence matter.",
    ...
    },
    {
      ...
      description: "Products that create support and stay areas without the maintenance routine of traditional timber.",
    ...
    },
    {
      ...
      description: "Pieces designed for vegetable gardens, urban composting, grow boxes and clean separation of green areas.",
  ...
  es: [
    {
      ...
      description: "Una alternativa a la madera para tarimas, pasarelas, rampas y zonas exteriores donde importan la humedad y el bajo mantenimiento.",
    ...
    },
    {
      ...
      description: "Soluciones para vallas, divisorias de terreno, resguardos de ecopuntos y protección de zonas técnicas.",
    ...
    },
    {
      ...
      description: "Equipamientos robustos para lugares donde la durabilidad, la limpieza sencilla y una presencia discreta son decisivas.",
    ...
    },
    {
      ...
      description: "Productos para crear zonas de apoyo y estancia sin depender del mantenimiento típico de la madera tradicional.",
    ...
    },
    {
      ...
      description: "Piezas pensadas para huertos, compostaje urbano, cajas de cultivo y separación limpia de zonas verdes.",
  ...
  pt: [
    {
      ...
      location: "Moita",
      summary: "Uma vedação de madeira com problemas de conservação deu lugar a uma solução em plástico reciclado.",
    ...
    },
    {
      ...
      summary: "Instalação de decking e mobiliário urbano em zona de areia junto ao rio para uma Junta de Freguesia.",
    ...
    },
    {
      ...
      location: "Moscavide",
      summary: "Oitenta metros de floreiras instaladas no último piso de uma habitação com trabalho de detalhe.",
  ...
  pt: [
    {
      ...
      excerpt: "A decisão de material num espaço público deve equilibrar manutenção, durabilidade, limpeza e impacto ambiental.",
    ...
    },
    {
      ...
      excerpt: "Quantidade, aplicação, código postal e contexto de instalação aceleram uma resposta séria de orçamento.",
    ...
    },
    {
      ...
      excerpt: "Compostores e caixas de cultivo podem transformar educação ambiental em infraestrutura diária.",
  ...
  en: [
    {
      ...
      slug: "mobiliario-urbano-madeira-metal",
      excerpt: "A public-space material decision should balance maintenance, durability, cleaning and environmental impact.",
      publishedAt: "2026-01-12",
      category: "Materials",
    ...
    },
    {
      ...
      slug: "pedido-orcamento-plastico-reciclado",
      excerpt: "Quantities, intended use, postcode and installation context speed up a serious quote response.",
      publishedAt: "2025-11-20",
      category: "Projects",
    ...
    },
    {
      ...
      slug: "compostagem-urbana-equipamento",
      excerpt: "Composters and grow boxes can turn environmental education into daily infrastructure.",
      publishedAt: "2025-10-25",
  ...
  es: [
    {
      ...
      slug: "mobiliario-urbano-madeira-metal",
      excerpt: "La decisión de material en espacio público debe equilibrar mantenimiento, durabilidad, limpieza e impacto ambiental.",
      publishedAt: "2026-01-12",
      category: "Materiales",
    ...
    },
    {
      ...
      slug: "pedido-orcamento-plastico-reciclado",
      excerpt: "Cantidades, aplicación, código postal y contexto de instalación aceleran una respuesta seria.",
      publishedAt: "2025-11-20",
      category: "Proyectos",
    ...
    },
    {
      ...
      slug: "compostagem-urbana-equipamento",
      excerpt: "Compostadores y cajas de cultivo convierten educación ambiental en infraestructura diaria.",
      publishedAt: "2025-10-25",
      category: "Ambiente",
  ...
  pt: {
    ...
    home: {
      hero: {
        ...
        lead: "A DaFábrica4You transforma resíduos plásticos em soluções exteriores duráveis, laváveis e pensadas para pouca manutenção."
      },
      intro: {
        kicker: "Da preocupação à peça instalada",
        title: "O material certo quando a madeira pede manutenção",
        lead: "Decks, vedações, floreiras, mobiliário urbano e peças à medida partem de uma ideia simples: usar melhor o plástico que já existe."
      },
      impact: {
      ...
      manifesto: {
        quote: "Um primeiro contacto deve explicar depressa, inspirar com calma e deixar claro qual é o próximo passo.",
    ...
    about: {
      hero: {
        ...
        lead: "A marca nasce da vontade de reduzir plástico em aterros e no mar, substituindo parte do uso de madeira por produtos em plástico reciclado."
      },
      timeline: [
        {
          title: "2011",
    ...
    productsPage: {
      hero: {
        ...
        lead: "Da sinalética aos decks, das floreiras aos resguardos, os produtos partem da mesma lógica: plástico reciclado aplicado com sentido prático."
      },
    ...
    contactPage: {
      hero: {
        ...
        lead: "Para acelerar resposta, envie objetivo, quantidades aproximadas, código postal e fotografias do local."
      },
  ...
  en: {
    ...
    home: {
      hero: {
        ...
        lead: "DaFábrica4You turns plastic waste into durable, washable outdoor solutions designed for low maintenance."
      },
      intro: {
        kicker: "From concern to installed product",
        title: "The right material when timber asks for maintenance",
        lead: "Decking, fencing, planters, urban furniture and custom pieces start from one practical idea: use existing plastic better."
      },
      impact: {
      ...
      manifesto: {
        quote: "A first contact should explain quickly, inspire calmly and make the next step obvious.",
    ...
    about: {
      hero: {
        ...
        lead: "The brand begins with the wish to reduce plastic in landfills and the sea, replacing part of timber use with recycled-plastic products."
      },
      timeline: [
    ...
    productsPage: {
      hero: {
        ...
        lead: "From signage to decking, from planters to screens, the product logic is the same: recycled plastic applied with practical sense."
      },
    ...
    contactPage: {
      hero: {
        ...
        lead: "To speed up the answer, send the goal, approximate quantities, postcode and photos of the place."
      },
  ...
  es: {
    ...
    home: {
      hero: {
        ...
        title: "Plástico reciclado para exteriores vivos",
        lead: "DaFábrica4You transforma residuos plásticos en soluciones exteriores duraderas, lavables y pensadas para bajo mantenimiento."
      },
      intro: {
        kicker: "De la preocupación a la pieza instalada",
        title: "El material correcto cuando la madera pide mantenimiento",
        lead: "Tarimas, vallas, jardineras, mobiliario urbano y piezas a medida parten de una idea práctica: usar mejor el plástico que ya existe."
      },
      impact: {
      ...
      manifesto: {
        quote: "Un primer contacto debe explicar rápido, inspirar con calma y dejar claro el siguiente paso.",
    ...
    about: {
      hero: {
        ...
        lead: "La marca nace del deseo de reducir plástico en vertederos y en el mar, sustituyendo parte del uso de madera por plástico reciclado."
      },
      timeline: [
    ...
    productsPage: {
      hero: {
        ...
        lead: "Desde señalética hasta tarimas, jardineras o resguardos, la lógica es la misma: plástico reciclado aplicado con sentido práctico."
      },
    ...
    contactPage: {
      hero: {
        ...
        lead: "Para acelerar la respuesta, envía objetivo, cantidades aproximadas, código postal y fotos del lugar."
      },
...
const localized = (value, language, fallback) => value?.[language]?.trim() || fallback;
const imageFor = (item, fallback) => item.image ?? fallback;
const productImagesFor = (item, fallback) => {
  if (item.images?.length) return item.images;
  if (item.image) return [item.image];
  return [fallback];
};
const caseStudyImagesFor = (item, fallback) => {
  if (item.images?.length) return item.images;
  if (item.image) return [item.image];
  return [fallback];
};
const productImageFallback = fallbackImages.product;
const caseStudyImageFallback = fallbackImages.caseStudy;
const blogImageFallback = fallbackImages.blog;
const imageFromSanity = (image, language, fallback) => ({
  url: image?.asset?.url || fallback.url,
  alt: localized(image?.alt, language, fallback.alt)
});
const imagesFromSanity = (mainImage, gallery, language, fallback) => {
  const images = [mainImage, ...gallery ?? []].filter((image) => Boolean(image?.asset?.url)).map((image) => imageFromSanity(image, language, fallback));
  return images.length ? images : [fallback];
};
const localizedList = (items, language, fallback) => {
  if (!items?.length) return fallback;
  return items.map((item, index) => localized(item, language, fallback[index] ?? "")).filter(Boolean);
};
const productsFromSanity = (products, language, fallback) => {
  if (!products?.length) return fallback;
  return products.filter((product) => product.slug?.current).map((product, index) => ({
...
const casesFromSanity = (cases, language, fallback) => {
  if (!cases?.length) return fallback;
  return cases.filter((item) => item.slug?.current).map((item, index) => ({
...
const postsFromSanity = (posts, language, fallback) => {
  if (!posts?.length) return fallback;
  return posts.filter((post) => post.slug?.current).map((post, index) => ({
...
const contentFromSanity = (collections) => {
...
export { caseStudyImageFallback as a, blogImageFallback as b, contentFromSanity as c, caseStudyImagesFor as d, productImagesFor as e, getLanguage as g, imageFor as i, languages as l, productImageFallback as p };
//# sourceMappingURL=site-content-DXdOWpkG.js.map
