...
test.describe('Sanity Studio content contract', () => {
  ...
  test('visual editing preview is wired through Studio and draft rendering', () => {
    ...
    expect(storeDetailRoute).toContain("storeProductDataAttribute('gallery')")
    expect(storeDetailRoute).toContain('{imageDataAttribute}')
    expect(storeDetailRoute).toContain('{galleryDataAttribute}')
    expect(storeMediaGallery).toContain('imageDataAttribute?: string')
    expect(storeMediaGallery).toContain('galleryDataAttribute?: string')
    expect(storeMediaGallery).toContain('selectedIndex === 0 ? imageDataAttribute : galleryDataAttribute')
  ...
  test('fallback content remains available when Studio is empty', () => {
    ...
    expect(contentModel).toContain('fallbackStoreImages.map(storeProductMediaImage)')
